...
let ageConfirm = document.getElementById('age');
...
function searchStudent() {
    let searchInput = document.getElementById('search-data').value;
...
function editButtonStudent() {
    ...
    document.getElementById('confirm').addEventListener('click', function () {
        userManager.studentList[index].name = document.getElementById('name-confirm').value;
        userManager.studentList[index].age = document.getElementById('age-confirm').value;
        userManager.studentList[index].phone = document.getElementById('phone-confirm').value;
        userManager.studentList[index].email = document.getElementById('email-confirm').value;
